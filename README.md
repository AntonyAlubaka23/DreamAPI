...
[![Version](https://img.shields.io/badge/version-0.0.6-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
    compileOnly("com.github.Dreamin-MC:DreamAPI:0.0.6:all")
}
```
...
|--------|---------|---------------|
| 🧪 In active development | `v0.0.6` | Paper 1.21.10 |
