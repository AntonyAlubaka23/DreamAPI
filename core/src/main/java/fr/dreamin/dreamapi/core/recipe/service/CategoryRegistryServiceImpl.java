...
import fr.dreamin.dreamapi.core.recipe.DefaultCategories;
...
@DreamAutoService(CategoryRegistryService.class)
public final class CategoryRegistryServiceImpl implements CategoryRegistryService, DreamService {
  ...
  public void onLoad(@NotNull Plugin plugin) {
    DefaultCategories.registerDefaults(this);
  }
